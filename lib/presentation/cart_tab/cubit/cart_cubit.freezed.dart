...
/// @nodoc
mixin _$CartState {
  Map<Dish, int> get items => throw _privateConstructorUsedError;
...
class _$_CartState implements _CartState {
  const _$_CartState({required final Map<Dish, int> items}) : _items = items;

  final Map<Dish, int> _items;
  @override
  Map<Dish, int> get items {
...
abstract class _CartState implements CartState {
  const factory _CartState({required final Map<Dish, int> items}) =
      _$_CartState;
